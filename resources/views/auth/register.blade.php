    ...
    <div class="row justify-center">
        <div class="lg:col-6">
            <div class="bg-blue-500 border rounded mb-10 lg:mb-0">
                ...
                <div class="m-10">
                    <h2 class="text-4xl font-bold mb-4">{{ __('Register') }}</h2>
                    ...
                    {{-- NAME --}}
                    <div class="col-md-6">
                    <label for="name" class="text-small text-white">{{ __('Name') }}</label>
                    ...
                    {{-- Username --}}
                    <div class="col-md-6">
                        <label for="username" class="text-small text-white">{{ __('Username') }}</label>
                    ...
                    {{-- EMAIL --}}
                    <div class="col-md-6">
                    <label for="email" class="text-small text-white">{{ __('Email') }}</label>
                    ...
                    <div class="col-md-6">
                    <label for="password-confirm" class="text-small text-white">{{ __('Confirm Password') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-4">
                                <button type="submit" class="mt-4 transition duration-200 ease-in-out bg-orange-500 font-bold text-white py-6 px-10 rounded hover:bg-gray-200 hover:text-gray-600">{{ __('Register') }}</button>
                            </div>
